 ...
 */
export const fetchUsers = createAsyncThunk<User[], void, ThunkApiConfig>(
  'users/fetchUsers',
 ...
 */
export const fetchUserById = createAsyncThunk<User, string, ThunkApiConfig>(
  'users/fetchUserById',
 ...
 */
export const createUser = createAsyncThunk<User, CreateUserPayload, ThunkApiConfig>(
  'users/createUser',
 ...
 */
export const updateUser = createAsyncThunk<User, UpdateUserPayload, ThunkApiConfig>(
  'users/updateUser',
