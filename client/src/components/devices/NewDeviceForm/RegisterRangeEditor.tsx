// client/src/components/devices/NewDeviceForm/RegisterRangeEditor.tsx
...
const RegisterRangeEditor: React.FC<RegisterRangeEditorProps> = ({
  initialData,
  onSave,
  onCancel,
}) => {
    ...
    <Form onSubmit={handleSubmit}>
      <Form.Group>
        ...
        <Input
          ...
          placeholder="e.g., Holding Registers"
        />
      </Form.Group>
      ...
      <Form.Actions>
        ...
        <Button type="submit">{initialData ? 'Update Range' : 'Add Range'}</Button>
      </Form.Actions>
    </Form>
  );
};

export default RegisterRangeEditor;
