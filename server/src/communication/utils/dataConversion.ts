    ...
    switch (byteOrder) {
        ...
        case ByteOrder.CDAB:
            ...
            [tempBuffer[0], tempBuffer[1], tempBuffer[2], tempBuffer[3]] = 
                [tempBuffer[2], tempBuffer[3], tempBuffer[0], tempBuffer[1]];
            break;
        case ByteOrder.BADC:
            // Swap bytes within each 16-bit word
            [tempBuffer[0], tempBuffer[1], tempBuffer[2], tempBuffer[3]] = 
                [tempBuffer[1], tempBuffer[0], tempBuffer[3], tempBuffer[2]];
            break;
        case ByteOrder.DCBA:
            // Reverse all bytes
            [tempBuffer[0], tempBuffer[1], tempBuffer[2], tempBuffer[3]] = 
                [tempBuffer[3], tempBuffer[2], tempBuffer[1], tempBuffer[0]];
            break;
        default:
    ...
    switch (byteOrder) {
        ...
        case ByteOrder.BADC:
            ...
            [
                ...
                tempBuffer[1], tempBuffer[0], tempBuffer[3], tempBuffer[2],
                tempBuffer[5], tempBuffer[4], tempBuffer[7], tempBuffer[6]
            ];
            break;
        case ByteOrder.DCBA:
            ...
            [
                ...
                tempBuffer[7], tempBuffer[6], tempBuffer[5], tempBuffer[4],
                tempBuffer[3], tempBuffer[2], tempBuffer[1], tempBuffer[0]
            ];
            break;
        default:
 ...
 * @param byteOrder Byte order
 */
export function uint16ToBuffer(
    value: number,
    byteOrder: ByteOrder = ByteOrder.AB
): Buffer {
    // Validate the value
 ...
 * @param byteOrder Byte order
 */
export function uint32ToBuffer(
    value: number,
    byteOrder: ByteOrder = ByteOrder.ABCD
): Buffer {
    // Validate the value
 ...
 * @param byteOrder Byte order
 */
export function float32ToBuffer(
    value: number,
    byteOrder: ByteOrder = ByteOrder.ABCD
): Buffer {
 ...
 * @param byteOrder Byte order
 */
export function float64ToBuffer(
    value: number,
    byteOrder: ByteOrder = ByteOrder.ABCD
): Buffer {
    // Create buffer and write value in big-endian format
