...
export class ModbusRtuClient extends EventEmitter implements Protocol, RawOperations {
     ...
     */
    public async readRegisters(registerType: any, startAddress: number, length: number, unitId?: number): Promise<any> {
        throw new Error("Method not implemented yet");
    }
     ...
     */
    public async writeSingleRegister(registerType: any, address: number, value: any, unitId?: number): Promise<any> {
        throw new Error("Method not implemented yet");
    }
     ...
     */
    public async writeMultipleRegisters(registerType: any, startAddress: number, values: any[], unitId?: number): Promise<any> {
        throw new Error("Method not implemented yet");
    }
     ...
     */
    public async executeCustomFunction(functionCode: number, data: Buffer, unitId?: number): Promise<any> {
        throw new Error("Method not implemented yet");
    }
                ...
                for (const regType of Object.keys(groupedParams)) {
                    ...
                    for (const operation of readOperations) {
                        ...
                        for (const param of operation.parameters) {
                            ...
                            const value = convertBufferToType(
                                result.buffer,
                                param.dataType,
                                offset
                            );
    ...
    public async writeParameter(
        ...
        try {
            ...
            const result = await this.writeRegisters(
                address,
                buffer,
                registerType
            );
    ...
    public async readRegisters(
        ...
        try {
            ...
            if (response.length < byteCount + 1) {
                throw new ModbusError(`Invalid response: expected ${byteCount + 1} bytes, got ${response.length}`);
            }
