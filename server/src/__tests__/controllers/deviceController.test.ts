...
deviceModelMock.findById.mockResolvedValueOnce = jest.fn().mockReturnValue(deviceModelMock.findById);
deviceModelMock.findById.mockRejectedValueOnce = jest.fn().mockReturnValue(deviceModelMock.findById);
...
deviceModelMock.findByIdAndUpdate.mockResolvedValueOnce = jest.fn().mockReturnValue(deviceModelMock.findByIdAndUpdate);
deviceModelMock.findByIdAndUpdate.mockRejectedValueOnce = jest.fn().mockReturnValue(deviceModelMock.findByIdAndUpdate);
