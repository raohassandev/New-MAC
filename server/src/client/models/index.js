...
exports.clientModels = exports.createDeviceModel = exports.HistoricalData = exports.Alert = exports.Profile = exports.Device = exports.User = void 0;
var Alert_1 = __importDefault(require("./Alert"));
exports.Alert = Alert_1.default;
var Device_1 = __importStar(require("./Device"));
exports.Device = Device_1.default;
Object.defineProperty(exports, "createDeviceModel", { enumerable: true, get: function () { return Device_1.createDeviceModel; } });
...
var clientModels = function (connection) {
    ...
    if (connection.readyState !== 1) {
        console.warn("Database connection not ready (state: ".concat(connection.readyState, "). Waiting for connection..."));
    }
    try {
        ...
        console.log("- Device model connected to: ".concat(((_a = DeviceModel.db) === null || _a === void 0 ? void 0 : _a.name) || 'unknown'));
        console.log("- HistoricalData model connected to: ".concat(((_b = HistoricalDataModel.db) === null || _b === void 0 ? void 0 : _b.name) || 'unknown'));
        ...
        console.error("Connection name: ".concat(connection.name, ", state: ").concat(connection.readyState));
